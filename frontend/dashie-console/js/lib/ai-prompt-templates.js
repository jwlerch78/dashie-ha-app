...
`;
    ...
    const AVAILABLE_TOOLS_LIST = `- calendar_events: query: {time_range: "today|tomorrow|this_week|next_week|weekend|next_30_days|next_60_days", member_name?: "name (for a specific person)", tags?: ["soccer"], mode?: "next|list"} - Family calendar events. Set member_name when the question is about one person; use mode "next" for a single upcoming event ("when is the next game"), "list" (default) for an overview ("what's on this weekend")
