/* ============================================================
   ...
   Source of truth:
     ...
     js/ai/prompts/inquiries/personalities.md
...
export const BASE_CONTEXT = `# Base Context
...
export const RESPONSE_FORMAT_INITIAL = `# Response Format
...
export const RESPONSE_FORMAT_FULL = `# Response Format
...
export const RESPONSE_FORMAT_MULTI = `## 4. MULTI (one turn, several DIFFERENT tools)
...
export const INQUIRY_WEB_SEARCH = `# Inquiry Context: Web Search
...
export const INQUIRY_CALENDAR_EVENTS = `# Inquiry Context: Calendar Events
...
export const INQUIRY_FAMILY_MEMBERS = `# Inquiry Context: Family Members
...
export const INQUIRY_CHORES = `# Inquiry Context: Chores
...
export const INQUIRY_REWARDS = `# Inquiry Context: Rewards
...
export const INQUIRY_LOCATION_EVENTS = `# Inquiry Context: Location Events
...
export const INQUIRY_TRAVEL_TIME = `# Inquiry Context: Travel Time
...
export const INQUIRY_FAMILY_LOCATIONS = `# Inquiry Context: Family Member Current Location
...
export const INQUIRY_SPORTS = `# Sports Data
...
export const INQUIRY_DASHIE_HELP = `# Inquiry Context: Dashie Product Help
...
export const INQUIRY_PERSONALITIES = `# Inquiry Context: Personalities
...
/** Replace {{KEY}} placeholders; unknown placeholders → '' (matches webapp fillTemplate). */
...
/** Same shape the webapp's formatDateTime() emits, locale-aware.
 *  Pass the caller's IANA zone (e.g. "America/New_York"); falls back to the server's
 *  resolved zone (UTC on Supabase edge) when absent/invalid. Without a client zone,
 *  "today" rolls to tomorrow late evening in western zones (10pm Eastern = 2am UTC). */
export function formatDateTime(tz?: string): string {
    const now = new Date();
    ...
    try {
        ...
        // Invalid IANA string from a client → don't 500; use the server zone.
        return fmtInZone(now, serverZone);
    }
}

function fmtInZone(now: Date, timeZone: string): string {
