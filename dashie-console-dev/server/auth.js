...
function writeStoredJwt({ jwt, userId, userEmail, userName, userPicture }) {
    ...
    // (No household-sharing reset needed here: householdSharing is ACCOUNT-scoped as of
    //  2026-07-13 — voice.householdSharing in user_settings — so a new/wiped account is
    //  simply off by default. The old per-instance /data store required a reset hook.)
